...
void PmsmControlCore::Trap_onEnter(MCType prev_mct){}
void PmsmControlCore::Trap_onExit(){}
//==========================================
// OPEN LOOP CODE
//==========================================
void PmsmControlCore::Trap_olstup_cfg(float vbus_init,const float time_tb[Trap::OLSTUP_TABLE_SIZE],const float ec_tb[Trap::OLSTUP_TABLE_SIZE],const float rpm_tb[Trap::OLSTUP_TABLE_SIZE], eldriver_mc3p_sector_t init_sector)
{
    if (state.Vbus_q31 == 0)
    {

...
void PmsmControlCore::Foc_onEnter(MCType prev_mct)
{
...
void PmsmControlCore::Foc_olstup_cfg(float vbus_init,const float time_tb[Foc::Foc::OLSTUP_TABLE_SIZE],const float ec_tb[Foc::Foc::OLSTUP_TABLE_SIZE],const float rpm_tb[Foc::Foc::OLSTUP_TABLE_SIZE])
{
    if (state.Vbus_q31 == 0)
    {

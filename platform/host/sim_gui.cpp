...
static void drawCurrentPlot(float height) {
    if (ImPlot::BeginPlot("Phase Currents", ImVec2(-1, height))) {
        ...
        ImPlot::PlotLine("Ia", &view_buffer[0], BUFFER_SIZE, 1, 0, sizeof(float) * CHANNELS);
        ImPlot::PlotLine("Ib", &view_buffer[1], BUFFER_SIZE, 1, 0, sizeof(float) * CHANNELS);
        ImPlot::PlotLine("Ic", &view_buffer[2], BUFFER_SIZE, 1, 0, sizeof(float) * CHANNELS);
...
static void drawVoltagePlot(float height) {
    if (ImPlot::BeginPlot("Phase Voltages", ImVec2(-1, height))) {
        ...
        ImPlot::PlotLine("Va", &view_buffer[3], BUFFER_SIZE, 1, 0, sizeof(float) * CHANNELS);
        ImPlot::PlotLine("Vb", &view_buffer[4], BUFFER_SIZE, 1, 0, sizeof(float) * CHANNELS);
        ImPlot::PlotLine("Vc", &view_buffer[5], BUFFER_SIZE, 1, 0, sizeof(float) * CHANNELS);

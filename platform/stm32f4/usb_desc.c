...
// Add at the very top of usb_desc.c, before any includes
#define ECODRIVE_VID 0x0000
#define ECODRIVE_PID 0x0000
#define MANUFACTURER  "OmarMagdy"
#define PRODUCT       "EcoDrive V0.1"
#define SERIAL        "194"
...
tusb_desc_device_t const desc_device = {
    ...
    .idVendor           = ECODRIVE_VID,
    .idProduct          = ECODRIVE_PID,
    .bcdDevice          = 0x0001,
...
uint8_t static desc_configuration[] = {
    ...
    TUD_VENDOR_DESCRIPTOR(ITF_NUM_VENDOR, 0, BULK_OUT_ENDPOINT_DIR, BULK_IN_ENDPOINT_DIR, CFG_TUD_VENDOR_EP_BUFSIZE),
};
